...
| T-010 | Persist tasks.md to repo storage | TBD | High | Open | TBD | Save tasks.md in GitHub or another simple persistent storage layer. | Session 0 | TBD |
| T-011 | Implement /update-task command | TBD | Medium | Open | TBD | Let whitelisted users update owner, priority, status, deadline, or description for an existing task. | Session 0 | TBD |
| T-012 | Add concise reply behavior | TBD | Medium | Open | TBD | Make Johnny answer briefly by default, based on johnny.md or equivalent config. | Session 0 | TBD |
| T-013 | Add /my-tasks command | TBD | Medium | Open | TBD | Show tasks filtered by the requesting user or mapped owner. | Session 0 | TBD |
| T-014 | Add project boundary check | TBD | Medium | Open | TBD | Softly reject or question requests that appear outside Johnny’s project scope. | Session 0 | TBD |
| T-015 | Add /what-did-i-miss command | TBD | Medium | Open | TBD | Summarize recent relevant group activity for someone who was offline. | Session 0 | TBD |
| T-016 | Add Sunday weekly summary job | TBD | Low | Open | TBD | Post a concise weekly summary every Sunday at 7:00, only if useful. | Session 0 | TBD |
| T-017 | Add decisions.md decision log | TBD | Low | Open | TBD | Track important project decisions in a structured Markdown file. | Session 0 | TBD |
| T-018 | Add ideas.md board | TBD | Low | Open | TBD | Track future product ideas, podcast ideas, and speculative improvements. | Session 0 | TBD |
| T-019 | Add /reload-config command | TBD | Low | Open | TBD | Let admins reload johnny.md or config without restarting the bot. | Session 0 | TBD |
| T-020 | Prototype task suggestions | TBD | Low | Open | TBD | Experiment with Johnny suggesting tasks from conversation context without adding noise. | Session 0 | TBD |
